                            ...
                            {output.type === 'opreturn' ? (
                                ...
                                <>
                                    ...
                                    { bolt11PayRequest && !swapInfo ?
                                        <Row isColumn>
                                            <p>This is a lightning network invoice to pay {bolt11PayRequest.satoshis} satoshi</p>
                                    ...
                                    { bolt11PayRequest && swapInfo && !swap.invoice ?
                                        ...
                                        <Row isColumn>
                                            ...
                                            <p>The fee for the service will be {swapInfo.fee} satoshis ({swapInfo.fee_fiat_value / 100} {swapInfo.fiat_currency_code})</p>
                                            <p>The swap transaction might fail, if it fails you will get the amount in the same account after 2 weeks</p>
                                            <Button onClick={() => createSubmarineSwap(selectedAccount.account, bolt11PayRequest.paymentRequest)}>
                                    ...
                                    { swap.invoice ?
                                        <Row isColumn>
                                            ...
                                            <div>If it faill you will get the amount back to {swap.refund_address}</div>
                                        </Row> : undefined}
