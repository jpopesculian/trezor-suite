...
const SettingsSuccessful = ({ selectedAccount }: WithInvityLayoutProps) => {
    ...
    return (
        <Wrapper>
            ...
            <Header>
                <Translation id="TR_INVITY_SETTINGS_SUCCESSFUL_HEADER" />
            </Header>
            <Description>
                <Translation id="TR_INVITY_SETTINGS_SUCCESSFUL_DESCRIPTION" />
            </Description>
            <Button onClick={() => navigateToInvityLogin()}>
                <Translation id="TR_INVITY_SETTINGS_SUCCESSFUL_BUTTON_LABEL" />
            </Button>
        </Wrapper>
    );
};

export default withInvityLayout(SettingsSuccessful, {
