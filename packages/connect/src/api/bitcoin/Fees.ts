...
export default class FeeLevels {
    ...
    constructor(coinInfo: CoinInfo) {
        ...
        this.levels = keys
            .sort(
                (levelA, levelB) =>
                    coinInfo.defaultFees[levelB as BitcoinDefaultFeesKeys] -
                    coinInfo.defaultFees[levelA as BitcoinDefaultFeesKeys],
            )
            .map(level => {
                ...
                return {
                    label,
                    feePerUnit: coinInfo.defaultFees[level as BitcoinDefaultFeesKeys].toString(),
                    blocks,
                };
            });
    }
